                ...
                child: Column(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("How does it look?", style: titilliumBold.copyWith(fontSize: 25, color: ColorResources.black),),
                        const SizedBox(height: 10,),
                        Text("Make sure your face is centered and visible. This will prevent any delays in your process",
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(child: Text("Looks good", style: titilliumBold.copyWith(color: ColorResources.white, fontSize: 20),),),
                      ),
                    ),
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(child: Text("Retake", style: titilliumBold.copyWith(color: ColorResources.black, fontSize: 20),),),
                      ),
                    ),
                  ],
                ),
