...
import 'package:product_delivery_app/screen/smile_photo/smile_photo_preview.dart';
          ...
          child: Column(
            children: [
              ...
              Column(
                ...
                children: [
                  Text("Smaile for the photo", style: titilliumBold.copyWith(fontSize: 30, color: ColorResources.black),),
                  const SizedBox(height: 5,),
                  SizedBox(
                      width: MediaQuery.of(context).size.width,
                      child: Text("Take a good selife so we can verify your identify", style: titilliumRegular.copyWith(color: Colors.black87, fontSize: 18),)),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text("In a place with plenty of light", style: titilliumRegular.copyWith(color: Colors.black87, fontSize: 18),),
                          ],
                        ),
                        const SizedBox(height: 5,),
                        Row(
                          children: [
                            ...
                            Text("Stand in front of a plain background", style: titilliumRegular.copyWith(color: Colors.black87, fontSize: 18),),
                          ],
                        ),
                        const SizedBox(height: 5,),
                        Row(
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Center(child: Text("Take photo", style: titilliumBold.copyWith(color: ColorResources.white, fontSize: 20),),),
                ),
              )
            ],
          ),
