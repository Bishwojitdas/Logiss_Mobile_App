...
class EnableCamera extends StatefulWidget {
  const EnableCamera({Key? key}) : super(key: key);
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        Text("Front of your driver's license", style: titilliumBold.copyWith(fontSize: 25, color: ColorResources.white),),
                      ],
                    ),
                  ],
                ),
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Front of your driver's license", style: titilliumBold.copyWith(fontSize: 25, color: ColorResources.black),),
                        ...
                        InkWell(
                          onTap: () async {
                            ...
                            try{
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (context) => EnableImagePreview(file: file),));
